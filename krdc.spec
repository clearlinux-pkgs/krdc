...
Version  : 24.02.1
Release  : 71
URL      : https://download.kde.org/stable/release-service/24.02.1/src/krdc-24.02.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/krdc-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/krdc-24.02.1.tar.xz.sig
...
%prep
%setup -q -n krdc-24.02.1
cd %{_builddir}/krdc-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711066254
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkrdccore.so.24.02.1
...
/usr/lib64/libkrdccore.so.24.02.1
