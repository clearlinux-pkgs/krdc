...
Version  : 22.08.0
Release  : 40
URL      : https://download.kde.org/stable/release-service/22.08.0/src/krdc-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/krdc-22.08.0.tar.xz
...
%prep
%setup -q -n krdc-22.08.0
cd %{_builddir}/krdc-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661539328
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkrdccore.so.22.08.0
