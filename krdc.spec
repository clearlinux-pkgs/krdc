...
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/krdc-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/krdc-22.08.3.tar.xz.sig
...
%prep
%setup -q -n krdc-22.08.3
cd %{_builddir}/krdc-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667866181
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libkrdccore.so.22.08.3
