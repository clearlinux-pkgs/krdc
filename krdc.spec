...
Version  : 24.08.0
Release  : 84
URL      : https://download.kde.org/stable/release-service/24.08.0/src/krdc-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/krdc-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/krdc-24.08.0.tar.xz.sig
...
%setup -q -n krdc-24.08.0
cd %{_builddir}/krdc-24.08.0
pushd ..
cp -a krdc-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724512306
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkrdccore.so.24.08.0
...
/usr/lib64/libkrdccore.so.24.08.0
