...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/krdc-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/krdc-23.08.5.tar.xz.sig
...
%prep
%setup -q -n krdc-23.08.5
cd %{_builddir}/krdc-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708385741
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkrdccore.so.23.08.5
...
/usr/lib64/libkrdccore.so.23.08.5
