...
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/krdc-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/krdc-24.05.0.tar.xz.sig
...
%setup -q -n krdc-24.05.0
cd %{_builddir}/krdc-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716514928
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkrdccore.so.24.05.0
...
/usr/lib64/libkrdccore.so.24.05.0
