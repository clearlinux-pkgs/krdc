...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/krdc-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/krdc-24.12.2.tar.xz.sig
...
%setup -q -n krdc-24.12.2
cd %{_builddir}/krdc-24.12.2
pushd ..
cp -a krdc-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738959012
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkrdccore.so.24.12.2
...
/usr/lib64/libkrdccore.so.24.12.2
